 ...
 * @version $Id: class._phpmailer.php 450 2010-06-23 16:46:33Z coolbru $
...
class PHPMailer {
 ...
 /**
   ...
   * @var string
   */
  public $DKIM_selector   = '_phpmailer';
 ...
 */
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    if ($langcode != 'en') { //There is no English translation file
      $l = @include $lang_path.'_phpmailer.lang-'.$langcode.'.php';
    }
  ...
  */
  ...
  public function CreateHeader() {
    ...
    if($this->XMailer) {
      ...
      $result .= $this->HeaderLine('X-Mailer', 'PHPMailer '.$this->Version.' (http://code.google.com/a/apache-extras.org/p/_phpmailer/)');
    }
  ...
  */
  ...
  public function DKIM_Add($headers_line, $subject, $body) {
    ...
    return "X-PHPMAILER-DKIM: _phpmailer.worxware.com\r\n".$dkimhdrs.$signed."\r\n";
  }
