 ...
 * @package PHPMailer
 * @author Andy Prevost
 * @author Marcus Bointon <_phpmailer@synchromedia.co.uk>
...
{
    /**
     * Holds the default _phpmailer instance.
     * @private
     * @type PHPMailer
     */
    public $Mail;
    ...
    public function setUp()
    {
        ...
        if (array_key_exists('mail_from', $_REQUEST)) {
            ...
            $this->Mail->From = 'unit_test@_phpmailer.example.com';
        }
        ...
        $this->Mail->addReplyTo('no_reply@_phpmailer.example.com', 'Reply Guy');
        $this->Mail->Sender = 'unit_test@_phpmailer.example.com';
    ...
    public function buildBody()
    {
        ...
        $ReportBody .= '---------------------' . $eol;
        $ReportBody .= '_phpmailer version: ' . $this->Mail->Version . $eol;
    ...
    public function testMultiplePlainFileAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/images/_phpmailer.png')) {
...
EOT;
    ...
    {
        $this->Mail->Body = 'Embedded Image: <img alt="_phpmailer" src="cid:my-attach">' .
            'Here is an image!</a>';
        $this->Mail->Subject .= ': Embedded Image';
        $this->Mail->isHTML(true);

        if (!$this->Mail->addEmbeddedImage(
            '../examples/images/_phpmailer.png',
            'my-attach',
            '_phpmailer.png',
            'base64',
            'image/png'
    ...
    public function testSigning()
    {
        ...
        $dn = array(
            ...
            'emailAddress' => '_phpmailer@example.com'
        );
        $password = 'password';
    ...
    public function testDKIM()
    {
        ...
        $this->Mail->DKIM_selector = '_phpmailer';
