 ...
 * @author Marcus Bointon (Synchro/coolbru) <_phpmailer@synchromedia.co.uk>
...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $foundlang = true;
        $lang_file = $lang_path . '_phpmailer.lang-' . $langcode . '.php';
        ...
        if (isset($images[2])) {
            foreach ($images[2] as $imgindex => $url) {
                ...
                if (preg_match('#^data:(image[^;,]*)(;base64)?,#', $url, $match)) {
                    ...
                    $cid = md5($url) . '@_phpmailer.0'; // RFC2392 S 2
