...
if ($Foods = Foods::getAllFoodsByCatId(MAX_PAGE_POST,$start,$cat)){ ?>
    <div class="row">
    ...
    <?php
    $totalFoods = count(Foods::getAllFoodsByCatId(0,0,$cat));
            ...
            <ul class="pagination mt-5 mb-4">
                ...
                <?php for ($i=1;$i<=$totalSections;$i++){
                    if ($i == $section)
                        ...
                        $class = "";
                    echo "<li class='page-item $class'><a class='page-link' href='./?cat=$cat&section=$i#products'>$i</a></li>" ;
                }
                ?>
